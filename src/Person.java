...
public class Person {
	...
	// Constructor for class name Person

	// Constructor for all the attributes
	Person(String firstName, String lastName, char lastNameInitial,
	...
	Person(String firstName, char lastNameInitial, double weight,
			int feet, int inches) {
		this.firstName = firstName;
		this.lastNameInitial = lastNameInitial;
		this.weight = weight;
